...
function emailthis5(s,b,d){
	var et='mailto:?subject=WorldwideBrands.com%20Spotlighted Supplier-Product Source of the Week:%20'+escape(s)+'&body=I found this supplier in the Worldwide Brands newsletter in the spotlight supplier of the week section. The name of the supplier is '+escape(s)+'.%0D%0AYou can check out their newsletter and the rest of the supplier information by going to their newsletter at:%0D%0Ahttp://www.worldwidebrands.com/wwb/news_detail3.asp?id='+ d + '%0D%0A';
	location.href=et;
}

function emailthis6(s,b,d){
	var et='mailto:?subject=Recommendation for the Worldwide Brands Affiliate Program and Affiliate Newsletter '+escape(s)+'&body=You have been sent a recommendation to read the Worldwide Brands Affiliate Newsletter by [Name]:%0D%0ATo read the newsletter, please go to: http://www.myaffiliateprogram.com/u/worldwid/t.asp?id=XXXXX&p=/wwb/affnews_detail.asp?id='+ d + '%0D%0AYou can also join the Worldwide Brands Affiliate Program for FREE and earn 25% commission on their products%0D%0A';
	location.href=et;
}


function emailthis7(s,b,d,e){
	var et='mailto:?subject=WorldwideBrands.com Spotlighted Supplier-Product Source of the Week: '+unescape(s)+'&body=I found this supplier through Auction TNT\'s Supplier of the week by Worldwide Brands. The name of the supplier is '+unescape(s)+'%0D%0AYou can check out Worldwide Brands\' newsletter for more supplier information:%0D%0Ahttp://www.worldwidebrands.com/wwb/news_detail3.asp?id='+ d + '%26kbid=' + e +'%0D%0A%0D%0A';
	location.href=et;
}
